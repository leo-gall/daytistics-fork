    ...
    <div class="container mx-auto flex justify-center items-center">
        ...
        >
            <input
                ...
                type="text"
                maxlength="1"
                class="shadow-xs flex w-[47px] sm:w-[50px] items-center justify-center rounded-lg border border-stroke bg-white p-2 text-center text-xl sm:text-2xl font-medium text-daytistics-gray-dark outline-none"
                :value="digit"
