...
const text = `There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly passage of Lorem Ipsum believable.`;
...
<template>
    <section class="relative z-20 overflow-hidden bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div class="container mx-auto">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20 xl:mb-[100px]">
                        <span class="block mb-2 text-lg font-semibold text-day-primary">
                            Check This Out
                        </span>
                        <h2 class="text-daytistics-gray-dark text-3xl font-bold sm:text-[40px]">
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                >
                    <div class="w-full px-4 lg:w-1/2">
                        <div
                            class="relative mb-10 overflow-hidden rounded-lg border border-[#F3F4FE] p-6 sm:px-10 sm:py-11 lg:px-8 2xl:px-14"
                        >
                            <h4
                                class="mb-6 text-lg font-semibold text-daytistics-gray-dark sm:text-xl lg:text-lg xl:text-xl"
                            >
                                {{ faq.header }}
                            </h4>
