<template>
    ...
    />
    <header class="relative isolate z-50 bg-white shadow-sm">
        <nav
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <component
                                            :is="item.icon"
                                            class="size-6 text-gray-600 group-hover:text-day-primary"
                                            aria-hidden="true"
                                        />
                                    </div>
                                    <a
            ...
            >
                <div class="flex items-center justify-between">
                    ...
                    >
                        <img
                            class="h-8 w-auto"
                            src="https://tailwindui.com/plus/logos/mark.svg?color=indigo&shade=600"
                            alt="Daytistics Logo"
                        />
                    </a>
                    <button
