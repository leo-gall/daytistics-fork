<template>
    <div
        class="bg-gradient-to-br from-gradient-1 to-gradient-2 min-h-screen flex items-center justify-center overflow-hidden"
    >
        <div class="max-w-md w-full bg-white rounded-lg shadow-xl overflow-hidden m-2 md:m-0">
            <div class="p-4 md:p-6">
                ...
                <h2 class="text-2xl font-bold text-center text-daytistics-gray-dark-2 mb-3">
            ...
            <p
                class="text-xs leading-5 text-gray-500 p-4 bg-daytistics-ivory border-t border-daytistics-gray-light"
            >
