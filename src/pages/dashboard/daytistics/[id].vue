<template>
    ...
    <div
        class="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8 w-full bg-gradient-to-t from-gradient-1 to-gradient-2"
    >
        <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="px-6 py-8 bg-gray-50 border-b border-gray-200">
                <h1 class="text-3xl font-bold text-day-primary">What you did on...</h1>
